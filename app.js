...
${csv}`;
  ...
  function WeeklyCountrySummary({ theme, countries, allMetrics }) {
    ...
    ), level === "country" && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(
      "button",
      {
