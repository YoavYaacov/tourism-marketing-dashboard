    ...
    const runAll = async () => {
      for (const competitor of selected) {
        ...
        try {
          ...
          setResults((prev) => __spreadProps(__spreadValues({}, prev), { [competitor]: { text: res.text } }));
        } catch (err) {
