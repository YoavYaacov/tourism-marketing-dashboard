(() => {
  ...
  function GlobalStyles() {
    return /* @__PURE__ */ React.createElement("style", null, `
      ...
      .tooltip-i .bubble { display:none; position:absolute; bottom:130%; right:0; left:auto; transform:none;
        background:#fef9c3; color:#78350f; font-size:12px; padding:8px 10px; border-radius:8px;
...
2. **ניתוחים מילוליים** (ניתוח המועצה, מסקנות השוואה, ניתוח מתחרים וכו') — אלה תמיד מבוססים על הנתונים האמיתיים שכבר במערכת, ורק "מנסחים" אותם למסקנות קריאות. הם עדיין דעה של כלי AI, לא עובדה מוחלטת — כדאי להתייחס אליהם כאל חוות דעת ראשונית לדיון, לא כפסק דין.
